    ...
    // ---------------------------------------------------- 1 · Al-Kawthar ---
    {
      ...
      build(b) {
        ...
        b.creature('bird', 40).creature('tortoise', 43, null, { range: 70 })
         ...
         .creature('snail', 30, null, { range: 30 });
      }
    },
    // ----------------------------------------------------- 2 · Al-Ikhlas ---
    {
      ...
      build(b) {
        ...
        b.creature('bird', 27).creature('bird', 60).creature('tortoise', 47, null, { range: 90 })
         ...
         .creature('rabbit', 55, null, { range: 60 }).creature('snail', 20, null, { range: 24 });
      }
    },
    // ------------------------------------------------------- 3 · Al-'Asr ---
    {
      ...
      build(b) {
        ...
        b.creature('bird', 17).creature('bird', 48).creature('tortoise', 66, null, { range: 60 })
         ...
         .creature('snail', 52, null, { range: 30 });
      }
    },
    // ------------------------------------------------------ 4 · Al-Falaq ---
    {
      ...
      build(b) {
        ...
        b.creature('bird', 30).creature('bird', 71).creature('tortoise', 18, null, { range: 50 })
         ...
         .creature('rabbit', 68, null, { range: 40 });
      }
    },
    // -------------------------------------------------------- 5 · An-Nas ---
    {
      ...
      build(b) {
        ...
        b.creature('bird', 16).creature('bird', 29).creature('bird', 35)
         ...
         .creature('snail', 31, null, { range: 26 }).creature('rabbit', 78, null, { range: 40 });
      }
    },
    // ------------------------------------------------------ 6 · Al-Fatiha --
    {
      ...
      build(b) {
        ...
        b.creature('bird', 22).creature('bird', 45).creature('bird', 58)
         ...
         .creature('rabbit', 30, null, { range: 40 }).creature('snail', 8, null, { range: 24 });
      }
    }
  ];
