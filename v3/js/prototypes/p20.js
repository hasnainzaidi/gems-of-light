// Quraysh learning-loop lab · P20 — the caravan road (STUB — room build pending)
...
(function () {
  ...
  const lab = {
    ...
    draw(ctx, W, H) {
      ...
      GOL.text(ctx, 'the caravan road — coming soon', W / 2, H * 0.58, { size: 18, weight: '800', color: '#F5EDD4' });
    }
  };
