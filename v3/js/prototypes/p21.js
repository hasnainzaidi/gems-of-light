// Quraysh learning-loop lab · P21 — raising the house (STUB — room build pending)
...
(function () {
  ...
  const lab = {
    ...
    draw(ctx, W, H) {
      ...
      GOL.text(ctx, 'raising the house — coming soon', W / 2, H * 0.58, { size: 18, weight: '800', color: '#F5EDD4' });
    }
  };
