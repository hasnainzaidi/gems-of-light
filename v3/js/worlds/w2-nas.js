...
(function () {
  ...
  GOL.registerWorld(2, {
    ...
    build(b) {
      ...
      b.gem(1, 14, 7);
      b.prop('lantern', 13).prop('olive', 16)
       .prop('flowers', 11, { v: 2 });
      ...
      b.gem(2, 27, 8);
      b.gem(3, 33, 7);
      b.prop('lantern', 20).prop('flowers', 29, { v: 1 })
       .prop('lantern', 35);
      ...
      b.gem(4, 46, 10);
      b.prop('lantern', 41).prop('flowers', 50, { v: 1 });
      ...
      b.prop('bush', 57, { v: 1 }).prop('lantern', 61)
       .prop('lantern', 66).prop('cypress', 69);
      ...
      b.campfire(89);
      b.door(96);
      b.prop('lantern', 86).prop('lantern', 94);
      ...
      b.seedRun(79, 85); // stop two paces before the campfire trigger
