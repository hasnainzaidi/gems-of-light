...
(function () {
  ...
  // nas (surah 114)
  GOL.WORD_FOLLOW.basit[114] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [5.0678, 3.4482, 3.5527, 6.191, 6.4784, 5.1461],
    verses: {
      1: [
        { text: "قُلْ", from: 0.00, to: 0.53 },
        { text: "أَعُوذُ", from: 0.53, to: 1.75 },
        { text: "بِرَبِّ", from: 1.75, to: 2.76 },
        { text: "ٱلنَّاسِ", from: 2.76, to: 5.07 }
      ],
      2: [
        { text: "مَلِكِ", from: 0.00, to: 0.97 },
        { text: "ٱلنَّاسِ", from: 0.97, to: 3.45 }
      ],
      3: [
        { text: "إِلَـٰهِ", from: 0.00, to: 1.40 },
        { text: "ٱلنَّاسِ", from: 1.40, to: 3.55 }
      ],
      4: [
        { text: "مِن", from: 0.00, to: 0.52 },
        { text: "شَرِّ", from: 0.52, to: 1.25 },
        { text: "ٱلْوَسْوَاسِ", from: 1.25, to: 3.53 },
        { text: "ٱلْخَنَّاسِ", from: 3.53, to: 6.19 }
      ],
      5: [
        { text: "ٱلَّذِى", from: 0.00, to: 1.19 },
        { text: "يُوَسْوِسُ", from: 1.19, to: 2.70 },
        { text: "فِى", from: 2.70, to: 3.27 },
        { text: "صُدُورِ", from: 3.27, to: 4.29 },
        { text: "ٱلنَّاسِ", from: 4.29, to: 6.48 }
      ],
      6: [
        { text: "مِنَ", from: 0.00, to: 0.57 },
        { text: "ٱلْجِنَّةِ", from: 0.57, to: 2.24 },
        { text: "وَٱلنَّاسِ", from: 2.24, to: 5.15 }
      ]
    }
  };
  // adiyat (surah 100)
  GOL.WORD_FOLLOW.basit[100] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [3.631, 3.5527, 3.6049, 3.7616, 3.5265, 6.8441, 5.8776, 5.5118, 6.0082, 4.0229, 7.1576],
    verses: {
      1: [
        { text: "وَٱلْعَـٰدِيَـٰتِ", from: 0.00, to: 2.29 },
        { text: "ضَبْحًا", from: 2.29, to: 3.63 }
      ],
      2: [
        { text: "فَٱلْمُورِيَـٰتِ", from: 0.00, to: 2.17 },
        { text: "قَدْحًا", from: 2.17, to: 3.55 }
      ],
      3: [
        { text: "فَٱلْمُغِيرَٰتِ", from: 0.00, to: 2.10 },
        { text: "صُبْحًا", from: 2.10, to: 3.60 }
      ],
      4: [
        { text: "فَأَثَرْنَ", from: 0.00, to: 1.38 },
        { text: "بِهِۦ", from: 1.38, to: 1.93 },
        { text: "نَقْعًا", from: 1.93, to: 3.76 }
      ],
      5: [
        { text: "فَوَسَطْنَ", from: 0.00, to: 1.38 },
        { text: "بِهِۦ", from: 1.38, to: 1.87 },
        { text: "جَمْعًا", from: 1.87, to: 3.53 }
      ],
      6: [
        { text: "إِنَّ", from: 0.00, to: 0.77 },
        { text: "ٱلْإِنسَـٰنَ", from: 0.77, to: 3.04 },
        { text: "لِرَبِّهِۦ", from: 3.04, to: 4.37 },
        { text: "لَكَنُودٌ", from: 4.37, to: 6.84 }
      ],
      7: [
        { text: "وَإِنَّهُۥ", from: 0.00, to: 1.37 },
        { text: "عَلَىٰ", from: 1.37, to: 2.59 },
        { text: "ذَٰلِكَ", from: 2.59, to: 3.65 },
        { text: "لَشَهِيدٌ", from: 3.65, to: 5.88 }
      ],
      8: [
        { text: "وَإِنَّهُۥ", from: 0.00, to: 1.26 },
        { text: "لِحُبِّ", from: 1.26, to: 2.15 },
        { text: "ٱلْخَيْرِ", from: 2.15, to: 3.45 },
        { text: "لَشَدِيدٌ", from: 3.45, to: 5.51 }
      ],
      9: [
        { text: "أَفَلَا", from: 0.00, to: 0.85 },
        { text: "يَعْلَمُ", from: 0.85, to: 1.70 },
        { text: "إِذَا", from: 1.70, to: 2.37 },
        { text: "بُعْثِرَ", from: 2.37, to: 3.11 },
        { text: "مَا", from: 3.11, to: 3.59 },
        { text: "فِى", from: 3.59, to: 4.07 },
        { text: "ٱلْقُبُورِ", from: 4.07, to: 6.01 }
      ],
      10: [
        { text: "وَحُصِّلَ", from: 0.00, to: 1.06 },
        { text: "مَا", from: 1.06, to: 1.57 },
        { text: "فِى", from: 1.57, to: 2.08 },
        { text: "ٱلصُّدُورِ", from: 2.08, to: 4.02 }
      ],
      11: [
        { text: "إِنَّ", from: 0.00, to: 0.73 },
        { text: "رَبَّهُم", from: 0.73, to: 1.99 },
        { text: "بِهِمْ", from: 1.99, to: 2.78 },
        { text: "يَوْمَئِذٍ", from: 2.78, to: 4.51 },
        { text: "لَّخَبِيرٌۢ", from: 4.51, to: 7.16 }
      ]
    }
  };
  // qadr (surah 97)
  GOL.WORD_FOLLOW.basit[97] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [8.6465, 5.8514, 5.6163, 11.4155, 4.7543],
    verses: {
      1: [
        { text: "إِنَّآ", from: 0.00, to: 1.59 },
        { text: "أَنزَلْنَـٰهُ", from: 1.59, to: 4.01 },
        { text: "فِى", from: 4.01, to: 4.78 },
        { text: "لَيْلَةِ", from: 4.78, to: 6.13 },
        { text: "ٱلْقَدْرِ", from: 6.13, to: 8.65 }
      ],
      2: [
        { text: "وَمَآ", from: 0.00, to: 1.11 },
        { text: "أَدْرَىٰكَ", from: 1.11, to: 2.55 },
        { text: "مَا", from: 2.55, to: 3.11 },
        { text: "لَيْلَةُ", from: 3.11, to: 4.09 },
        { text: "ٱلْقَدْرِ", from: 4.09, to: 5.85 }
      ],
      3: [
        { text: "لَيْلَةُ", from: 0.00, to: 1.00 },
        { text: "ٱلْقَدْرِ", from: 1.00, to: 2.08 },
        { text: "خَيْرٌ", from: 2.08, to: 2.95 },
        { text: "مِّنْ", from: 2.95, to: 3.56 },
        { text: "أَلْفِ", from: 3.56, to: 4.21 },
        { text: "شَهْرٍ", from: 4.21, to: 5.62 }
      ],
      4: [
        { text: "تَنَزَّلُ", from: 0.00, to: 1.02 },
        { text: "ٱلْمَلَـٰٓئِكَةُ", from: 1.02, to: 3.49 },
        { text: "وَٱلرُّوحُ", from: 3.49, to: 5.18 },
        { text: "فِيهَا", from: 5.18, to: 6.28 },
        { text: "بِإِذْنِ", from: 6.28, to: 7.13 },
        { text: "رَبِّهِم", from: 7.13, to: 8.14 },
        { text: "مِّن", from: 8.14, to: 8.73 },
        { text: "كُلِّ", from: 8.73, to: 9.33 },
        { text: "أَمْرٍ", from: 9.33, to: 11.42 }
      ],
      5: [
        { text: "سَلَـٰمٌ", from: 0.00, to: 1.03 },
        { text: "هِىَ", from: 1.03, to: 1.50 },
        { text: "حَتَّىٰ", from: 1.50, to: 2.53 },
        { text: "مَطْلَعِ", from: 2.53, to: 3.27 },
        { text: "ٱلْفَجْرِ", from: 3.27, to: 4.75 }
      ]
    }
  };
  // kawthar (surah 108)
  GOL.WORD_FOLLOW.basit[108] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [5.9037, 3.7355, 4.4669],
    verses: {
      1: [
        { text: "إِنَّآ", from: 0.00, to: 1.35 },
        { text: "أَعْطَيْنَـٰكَ", from: 1.35, to: 3.55 },
        { text: "ٱلْكَوْثَرَ", from: 3.55, to: 5.90 }
      ],
      2: [
        { text: "فَصَلِّ", from: 0.00, to: 0.88 },
        { text: "لِرَبِّكَ", from: 0.88, to: 1.99 },
        { text: "وَٱنْحَرْ", from: 1.99, to: 3.74 }
      ],
      3: [
        { text: "إِنَّ", from: 0.00, to: 0.65 },
        { text: "شَانِئَكَ", from: 0.65, to: 1.94 },
        { text: "هُوَ", from: 1.94, to: 2.54 },
        { text: "ٱلْأَبْتَرُ", from: 2.54, to: 4.47 }
      ]
    }
  };
  // duha (surah 93)
  GOL.WORD_FOLLOW.basit[93] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [2.0637, 3.3437, 5.0678, 5.9559, 5.4073, 6.191, 7.68, 6.0343, 5.7208, 6.1649, 5.9037],
    verses: {
      1: [
        { text: "وَٱلضُّحَىٰ", from: 0.00, to: 2.06 }
      ],
      2: [
        { text: "وَٱلَّيْلِ", from: 0.00, to: 1.34 },
        { text: "إِذَا", from: 1.34, to: 2.03 },
        { text: "سَجَىٰ", from: 2.03, to: 3.34 }
      ],
      3: [
        { text: "مَا", from: 0.00, to: 0.56 },
        { text: "وَدَّعَكَ", from: 0.56, to: 1.72 },
        { text: "رَبُّكَ", from: 1.72, to: 2.53 },
        { text: "وَمَا", from: 2.53, to: 3.43 },
        { text: "قَلَىٰ", from: 3.43, to: 5.07 }
      ],
      4: [
        { text: "وَلَلْـَٔاخِرَةُ", from: 0.00, to: 1.83 },
        { text: "خَيْرٌ", from: 1.83, to: 2.62 },
        { text: "لَّكَ", from: 2.62, to: 3.18 },
        { text: "مِنَ", from: 3.18, to: 3.57 },
        { text: "ٱلْأُولَىٰ", from: 3.57, to: 5.96 }
      ],
      5: [
        { text: "وَلَسَوْفَ", from: 0.00, to: 1.16 },
        { text: "يُعْطِيكَ", from: 1.16, to: 2.31 },
        { text: "رَبُّكَ", from: 2.31, to: 3.02 },
        { text: "فَتَرْضَىٰٓ", from: 3.02, to: 5.41 }
      ],
      6: [
        { text: "أَلَمْ", from: 0.00, to: 0.72 },
        { text: "يَجِدْكَ", from: 0.72, to: 1.82 },
        { text: "يَتِيمًا", from: 1.82, to: 3.54 },
        { text: "فَـَٔاوَىٰ", from: 3.54, to: 6.19 }
      ],
      7: [
        { text: "وَوَجَدَكَ", from: 0.00, to: 2.16 },
        { text: "ضَآلًّا", from: 2.16, to: 4.74 },
        { text: "فَهَدَىٰ", from: 4.74, to: 7.68 }
      ],
      8: [
        { text: "وَوَجَدَكَ", from: 0.00, to: 1.60 },
        { text: "عَآئِلًا", from: 1.60, to: 3.56 },
        { text: "فَأَغْنَىٰ", from: 3.56, to: 6.03 }
      ],
      9: [
        { text: "فَأَمَّا", from: 0.00, to: 1.35 },
        { text: "ٱلْيَتِيمَ", from: 1.35, to: 3.14 },
        { text: "فَلَا", from: 3.14, to: 4.04 },
        { text: "تَقْهَرْ", from: 4.04, to: 5.72 }
      ],
      10: [
        { text: "وَأَمَّا", from: 0.00, to: 1.48 },
        { text: "ٱلسَّآئِلَ", from: 1.48, to: 3.55 },
        { text: "فَلَا", from: 3.55, to: 4.44 },
        { text: "تَنْهَرْ", from: 4.44, to: 6.16 }
      ],
      11: [
        { text: "وَأَمَّا", from: 0.00, to: 1.59 },
        { text: "بِنِعْمَةِ", from: 1.59, to: 2.92 },
  ...
  // lail (surah 92)
  GOL.WORD_FOLLOW.basit[92] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [3.7094, 4.702, 5.6947, 4.7282, 5.5902, 3.7878, 4.2318, 6.2694, 3.5527, 4.4408, 6.9224, 4.8065, 5.8514, 6.5829, 5.2245, 4.3624, 4.7543, 5.5641, 8.5943, 6.2694, 2.8996],
    verses: {
      1: [
        { text: "وَٱلَّيْلِ", from: 0.00, to: 1.34 },
        { text: "إِذَا", from: 1.34, to: 2.04 },
        { text: "يَغْشَىٰ", from: 2.04, to: 3.71 }
      ],
      2: [
        { text: "وَٱلنَّهَارِ", from: 0.00, to: 1.94 },
        { text: "إِذَا", from: 1.94, to: 2.72 },
        { text: "تَجَلَّىٰ", from: 2.72, to: 4.70 }
      ],
      3: [
        { text: "وَمَا", from: 0.00, to: 0.85 },
        { text: "خَلَقَ", from: 0.85, to: 1.45 },
        { text: "ٱلذَّكَرَ", from: 1.45, to: 2.62 },
        { text: "وَٱلْأُنثَىٰٓ", from: 2.62, to: 5.69 }
      ],
      4: [
        { text: "إِنَّ", from: 0.00, to: 0.78 },
        { text: "سَعْيَكُمْ", from: 0.78, to: 2.33 },
        { text: "لَشَتَّىٰ", from: 2.33, to: 4.73 }
      ],
      5: [
        { text: "فَأَمَّا", from: 0.00, to: 1.24 },
        { text: "مَنْ", from: 1.24, to: 1.70 },
        { text: "أَعْطَىٰ", from: 1.70, to: 3.03 },
        { text: "وَٱتَّقَىٰ", from: 3.03, to: 5.59 }
      ],
      6: [
        { text: "وَصَدَّقَ", from: 0.00, to: 1.27 },
        { text: "بِٱلْحُسْنَىٰ", from: 1.27, to: 3.79 }
      ],
      7: [
        { text: "فَسَنُيَسِّرُهُۥ", from: 0.00, to: 1.86 },
        { text: "لِلْيُسْرَىٰ", from: 1.86, to: 4.23 }
      ],
      8: [
        { text: "وَأَمَّا", from: 0.00, to: 1.62 },
        { text: "مَنۢ", from: 1.62, to: 2.16 },
        { text: "بَخِلَ", from: 2.16, to: 2.97 },
        { text: "وَٱسْتَغْنَىٰ", from: 2.97, to: 6.27 }
      ],
      9: [
        { text: "وَكَذَّبَ", from: 0.00, to: 1.19 },
        { text: "بِٱلْحُسْنَىٰ", from: 1.19, to: 3.55 }
      ],
      10: [
        { text: "فَسَنُيَسِّرُهُۥ", from: 0.00, to: 2.03 },
        { text: "لِلْعُسْرَىٰ", from: 2.03, to: 4.44 }
      ],
      11: [
        { text: "وَمَا", from: 0.00, to: 0.79 },
        { text: "يُغْنِى", from: 0.79, to: 1.78 },
        { text: "عَنْهُ", from: 1.78, to: 2.35 },
        { text: "مَالُهُۥٓ", from: 2.35, to: 3.69 },
        { text: "إِذَا", from: 3.69, to: 4.37 },
        { text: "تَرَدَّىٰٓ", from: 4.37, to: 6.92 }
      ],
      12: [
        { text: "إِنَّ", from: 0.00, to: 0.75 },
        { text: "عَلَيْنَا", from: 0.75, to: 2.41 },
        { text: "لَلْهُدَىٰ", from: 2.41, to: 4.81 }
      ],
      13: [
        { text: "وَإِنَّ", from: 0.00, to: 0.89 },
        { text: "لَنَا", from: 0.89, to: 1.61 },
        { text: "لَلْـَٔاخِرَةَ", from: 1.61, to: 3.14 },
        { text: "وَٱلْأُولَىٰ", from: 3.14, to: 5.85 }
      ],
      14: [
        { text: "فَأَنذَرْتُكُمْ", from: 0.00, to: 2.29 },
        { text: "نَارًا", from: 2.29, to: 3.90 },
        { text: "تَلَظَّىٰ", from: 3.90, to: 6.58 }
      ],
      15: [
        { text: "لَا", from: 0.00, to: 0.51 },
        { text: "يَصْلَىٰهَآ", from: 0.51, to: 2.45 },
        { text: "إِلَّا", from: 2.45, to: 3.31 },
        { text: "ٱلْأَشْقَى", from: 3.31, to: 5.22 }
      ],
      16: [
        { text: "ٱلَّذِى", from: 0.00, to: 1.15 },
        { text: "كَذَّبَ", from: 1.15, to: 1.96 },
        { text: "وَتَوَلَّىٰ", from: 1.96, to: 4.36 }
      ],
      17: [
        { text: "وَسَيُجَنَّبُهَا", from: 0.00, to: 2.58 },
        { text: "ٱلْأَتْقَى", from: 2.58, to: 4.75 }
      ],
      18: [
        { text: "ٱلَّذِى", from: 0.00, to: 1.13 },
        { text: "يُؤْتِى", from: 1.13, to: 2.22 },
        { text: "مَالَهُۥ", from: 2.22, to: 3.18 },
        { text: "يَتَزَكَّىٰ", from: 3.18, to: 5.56 }
      ],
      19: [
        { text: "وَمَا", from: 0.00, to: 1.13 },
        { text: "لِأَحَدٍ", from: 1.13, to: 2.31 },
        { text: "عِندَهُۥ", from: 2.31, to: 3.39 },
        { text: "مِن", from: 3.39, to: 3.93 },
        { text: "نِّعْمَةٍ", from: 3.93, to: 5.33 },
        { text: "تُجْزَىٰٓ", from: 5.33, to: 8.59 }
      ],
      20: [
        { text: "إِلَّا", from: 0.00, to: 0.89 },
        { text: "ٱبْتِغَآءَ", from: 0.89, to: 2.43 },
        { text: "وَجْهِ", from: 2.43, to: 3.16 },
        { text: "رَبِّهِ", from: 3.16, to: 3.93 },
        { text: "ٱلْأَعْلَىٰ", from: 3.93, to: 6.27 }
      ],
      21: [
        { text: "وَلَسَوْفَ", from: 0.00, to: 1.26 },
        { text: "يَرْضَىٰ", from: 1.26, to: 2.90 }
      ]
    }
  };
  // fatiha (surah 1)
  GOL.WORD_FOLLOW.basit[1] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [4.3624, 5.3029, 4.0229, 4.5453, 5.6163, 4.8065, 13.1396],
    verses: {
      1: [
        { text: "بِسْمِ", from: 0.00, to: 0.48 },
        { text: "ٱللَّهِ", from: 0.48, to: 1.24 },
        { text: "ٱلرَّحْمَـٰنِ", from: 1.24, to: 2.67 },
        { text: "ٱلرَّحِيمِ", from: 2.67, to: 4.36 }
      ],
      2: [
        { text: "ٱلْحَمْدُ", from: 0.00, to: 1.09 },
        { text: "لِلَّهِ", from: 1.09, to: 1.92 },
        { text: "رَبِّ", from: 1.92, to: 2.53 },
        { text: "ٱلْعَـٰلَمِينَ", from: 2.53, to: 5.30 }
      ],
      3: [
        { text: "ٱلرَّحْمَـٰنِ", from: 0.00, to: 1.94 },
        { text: "ٱلرَّحِيمِ", from: 1.94, to: 4.02 }
      ],
      4: [
        { text: "مَـٰلِكِ", from: 0.00, to: 1.32 },
        { text: "يَوْمِ", from: 1.32, to: 2.38 },
        { text: "ٱلدِّينِ", from: 2.38, to: 4.55 }
      ],
      5: [
        { text: "إِيَّاكَ", from: 0.00, to: 1.23 },
        { text: "نَعْبُدُ", from: 1.23, to: 2.04 },
        { text: "وَإِيَّاكَ", from: 2.04, to: 3.59 },
        { text: "نَسْتَعِينُ", from: 3.59, to: 5.62 }
      ],
      6: [
        { text: "ٱهْدِنَا", from: 0.00, to: 1.12 },
        { text: "ٱلصِّرَٰطَ", from: 1.12, to: 2.51 },
        { text: "ٱلْمُسْتَقِيمَ", from: 2.51, to: 4.81 }
      ],
      7: [
        { text: "صِرَٰطَ", from: 0.00, to: 0.92 },
        { text: "ٱلَّذِينَ", from: 0.92, to: 2.31 },
        { text: "أَنْعَمْتَ", from: 2.31, to: 3.40 },
        { text: "عَلَيْهِمْ", from: 3.40, to: 4.63 },
        { text: "غَيْرِ", from: 4.63, to: 5.41 },
        { text: "ٱلْمَغْضُوبِ", from: 5.41, to: 7.07 },
        { text: "عَلَيْهِمْ", from: 7.07, to: 8.29 },
        { text: "وَلَا", from: 8.29, to: 9.21 },
        { text: "ٱلضَّآلِّينَ", from: 9.21, to: 13.14 }
      ]
    }
  };
  // ikhlas (surah 112)
  GOL.WORD_FOLLOW.basit[112] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [3.1608, 2.8473, 3.4482, 4.258],
    verses: {
      1: [
        { text: "قُلْ", from: 0.00, to: 0.43 },
        { text: "هُوَ", from: 0.43, to: 1.00 },
        { text: "ٱللَّهُ", from: 1.00, to: 2.04 },
        { text: "أَحَدٌ", from: 2.04, to: 3.16 }
      ],
      2: [
        { text: "ٱللَّهُ", from: 0.00, to: 1.13 },
        { text: "ٱلصَّمَدُ", from: 1.13, to: 2.85 }
      ],
      3: [
        { text: "لَمْ", from: 0.00, to: 0.42 },
        { text: "يَلِدْ", from: 0.42, to: 1.18 },
        { text: "وَلَمْ", from: 1.18, to: 1.94 },
        { text: "يُولَدْ", from: 1.94, to: 3.45 }
      ],
      4: [
        { text: "وَلَمْ", from: 0.00, to: 0.71 },
        { text: "يَكُن", from: 0.71, to: 1.42 },
        { text: "لَّهُۥ", from: 1.42, to: 1.97 },
        { text: "كُفُوًا", from: 1.97, to: 3.08 },
        { text: "أَحَدٌۢ", from: 3.08, to: 4.26 }
      ]
    }
  };
  // nasr (surah 110)
  GOL.WORD_FOLLOW.basit[110] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [5.8776, 7.8106, 9.5869],
    verses: {
      1: [
        { text: "إِذَا", from: 0.00, to: 0.77 },
        { text: "جَآءَ", from: 0.77, to: 2.08 },
        { text: "نَصْرُ", from: 2.08, to: 2.73 },
        { text: "ٱللَّهِ", from: 2.73, to: 3.76 },
        { text: "وَٱلْفَتْحُ", from: 3.76, to: 5.88 }
      ],
      2: [
        { text: "وَرَأَيْتَ", from: 0.00, to: 1.09 },
        { text: "ٱلنَّاسَ", from: 1.09, to: 2.22 },
        { text: "يَدْخُلُونَ", from: 2.22, to: 3.49 },
        { text: "فِى", from: 3.49, to: 3.95 },
        { text: "دِينِ", from: 3.95, to: 4.58 },
        { text: "ٱللَّهِ", from: 4.58, to: 5.43 },
        { text: "أَفْوَاجًا", from: 5.43, to: 7.81 }
      ],
      3: [
        { text: "فَسَبِّحْ", from: 0.00, to: 1.09 },
        { text: "بِحَمْدِ", from: 1.09, to: 2.00 },
        { text: "رَبِّكَ", from: 2.00, to: 2.86 },
        { text: "وَٱسْتَغْفِرْهُ", from: 2.86, to: 4.81 },
        { text: "ۚ", from: 4.81, to: 4.94 },
        { text: "إِنَّهُۥ", from: 4.94, to: 5.81 },
        { text: "كَانَ", from: 5.81, to: 6.62 },
        { text: "تَوَّابًۢا", from: 6.62, to: 9.59 }
      ]
    }
  };
  // masad (surah 111)
  GOL.WORD_FOLLOW.basit[111] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [6.2955, 6.2694, 5.2506, 5.2245, 5.5118],
    verses: {
      1: [
        { text: "تَبَّتْ", from: 0.00, to: 1.03 },
        { text: "يَدَآ", from: 1.03, to: 2.44 },
        { text: "أَبِى", from: 2.44, to: 3.42 },
        { text: "لَهَبٍ", from: 3.42, to: 4.35 },
        { text: "وَتَبَّ", from: 4.35, to: 6.30 }
      ],
      2: [
        { text: "مَآ", from: 0.00, to: 0.82 },
        { text: "أَغْنَىٰ", from: 0.82, to: 2.14 },
        { text: "عَنْهُ", from: 2.14, to: 2.83 },
        { text: "مَالُهُۥ", from: 2.83, to: 3.88 },
        { text: "وَمَا", from: 3.88, to: 4.83 },
        { text: "كَسَبَ", from: 4.83, to: 6.27 }
      ],
      3: [
        { text: "سَيَصْلَىٰ", from: 0.00, to: 1.71 },
        { text: "نَارًا", from: 1.71, to: 3.00 },
        { text: "ذَاتَ", from: 3.00, to: 3.84 },
        { text: "لَهَبٍ", from: 3.84, to: 5.25 }
      ],
      4: [
        { text: "وَٱمْرَأَتُهُۥ", from: 0.00, to: 1.84 },
        { text: "حَمَّالَةَ", from: 1.84, to: 3.39 },
        { text: "ٱلْحَطَبِ", from: 3.39, to: 5.22 }
      ],
      5: [
        { text: "فِى", from: 0.00, to: 0.66 },
        { text: "جِيدِهَا", from: 0.66, to: 2.22 },
        { text: "حَبْلٌ", from: 2.22, to: 3.08 },
        { text: "مِّن", from: 3.08, to: 3.79 },
        { text: "مَّسَدٍۭ", from: 3.79, to: 5.51 }
      ]
    }
  };
  // quraish (surah 106)
  GOL.WORD_FOLLOW.basit[106] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [3.3959, 6.8702, 5.0155, 10.5796],
    verses: {
      1: [
        { text: "لِإِيلَـٰفِ", from: 0.00, to: 1.82 },
        { text: "قُرَيْشٍ", from: 1.82, to: 3.40 }
      ],
      2: [
        { text: "إِۦلَـٰفِهِمْ", from: 0.00, to: 1.58 },
        { text: "رِحْلَةَ", from: 1.58, to: 2.45 },
        { text: "ٱلشِّتَآءِ", from: 2.45, to: 4.29 },
        { text: "وَٱلصَّيْفِ", from: 4.29, to: 6.87 }
      ],
      3: [
        { text: "فَلْيَعْبُدُوا۟", from: 0.00, to: 1.80 },
        { text: "رَبَّ", from: 1.80, to: 2.32 },
        { text: "هَـٰذَا", from: 2.32, to: 3.38 },
        { text: "ٱلْبَيْتِ", from: 3.38, to: 5.02 }
      ],
      4: [
        { text: "ٱلَّذِىٓ", from: 0.00, to: 2.06 },
        { text: "أَطْعَمَهُم", from: 2.06, to: 3.62 },
        { text: "مِّن", from: 3.62, to: 4.36 },
        { text: "جُوعٍ", from: 4.36, to: 5.40 },
        { text: "وَءَامَنَهُم", from: 5.40, to: 7.54 },
        { text: "مِّنْ", from: 7.54, to: 8.27 },
        { text: "خَوْفٍۭ", from: 8.27, to: 10.58 }
      ]
    }
  };
  // fil (surah 105)
  GOL.WORD_FOLLOW.basit[105] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [6.6612, 5.0678, 5.1461, 7.5755, 5.0155],
    verses: {
      1: [
        { text: "أَلَمْ", from: 0.00, to: 0.62 },
        { text: "تَرَ", from: 0.62, to: 1.04 },
        { text: "كَيْفَ", from: 1.04, to: 1.79 },
        { text: "فَعَلَ", from: 1.79, to: 2.41 },
        { text: "رَبُّكَ", from: 2.41, to: 3.20 },
        { text: "بِأَصْحَـٰبِ", from: 3.20, to: 4.70 },
        { text: "ٱلْفِيلِ", from: 4.70, to: 6.66 }
      ],
      2: [
        { text: "أَلَمْ", from: 0.00, to: 0.61 },
        { text: "يَجْعَلْ", from: 0.61, to: 1.55 },
        { text: "كَيْدَهُمْ", from: 1.55, to: 2.70 },
        { text: "فِى", from: 2.70, to: 3.23 },
        { text: "تَضْلِيلٍ", from: 3.23, to: 5.07 }
      ],
      3: [
        { text: "وَأَرْسَلَ", from: 0.00, to: 1.06 },
        { text: "عَلَيْهِمْ", from: 1.06, to: 2.11 },
        { text: "طَيْرًا", from: 2.11, to: 3.17 },
        { text: "أَبَابِيلَ", from: 3.17, to: 5.15 }
      ],
      4: [
        { text: "تَرْمِيهِم", from: 0.00, to: 1.98 },
        { text: "بِحِجَارَةٍ", from: 1.98, to: 4.08 },
        { text: "مِّن", from: 4.08, to: 4.92 },
        { text: "سِجِّيلٍ", from: 4.92, to: 7.58 }
      ],
      5: [
        { text: "فَجَعَلَهُمْ", from: 0.00, to: 1.54 },
        { text: "كَعَصْفٍ", from: 1.54, to: 2.67 },
        { text: "مَّأْكُولٍۭ", from: 2.67, to: 5.02 }
      ]
    }
  };
  // humazah (surah 104)
  GOL.WORD_FOLLOW.basit[104] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [4.7543, 5.2767, 6.1388, 6.7396, 5.0678, 3.84, 4.8849, 5.2506, 3.9967],
    verses: {
      1: [
        { text: "وَيْلٌ", from: 0.00, to: 1.02 },
        { text: "لِّكُلِّ", from: 1.02, to: 2.05 },
        { text: "هُمَزَةٍ", from: 2.05, to: 3.03 },
        { text: "لُّمَزَةٍ", from: 3.03, to: 4.75 }
      ],
      2: [
        { text: "ٱلَّذِى", from: 0.00, to: 1.23 },
        { text: "جَمَعَ", from: 1.23, to: 1.91 },
        { text: "مَالًا", from: 1.91, to: 3.19 },
        { text: "وَعَدَّدَهُۥ", from: 3.19, to: 5.28 }
      ],
      3: [
        { text: "يَحْسَبُ", from: 0.00, to: 1.27 },
        { text: "أَنَّ", from: 1.27, to: 2.05 },
        { text: "مَالَهُۥٓ", from: 2.05, to: 4.02 },
        { text: "أَخْلَدَهُۥ", from: 4.02, to: 6.14 }
      ],
      4: [
        { text: "كَلَّا", from: 0.00, to: 1.24 },
        { text: "ۖ", from: 1.24, to: 1.41 },
        { text: "لَيُنۢبَذَنَّ", from: 1.41, to: 3.50 },
        { text: "فِى", from: 3.50, to: 4.24 },
        { text: "ٱلْحُطَمَةِ", from: 4.24, to: 6.74 }
      ],
      5: [
        { text: "وَمَآ", from: 0.00, to: 1.13 },
        { text: "أَدْرَىٰكَ", from: 1.13, to: 2.60 },
        { text: "مَا", from: 2.60, to: 3.16 },
        { text: "ٱلْحُطَمَةُ", from: 3.16, to: 5.07 }
      ],
      6: [
        { text: "نَارُ", from: 0.00, to: 0.76 },
        { text: "ٱللَّهِ", from: 0.76, to: 1.77 },
        { text: "ٱلْمُوقَدَةُ", from: 1.77, to: 3.84 }
      ],
      7: [
        { text: "ٱلَّتِى", from: 0.00, to: 1.12 },
        { text: "تَطَّلِعُ", from: 1.12, to: 2.11 },
        { text: "عَلَى", from: 2.11, to: 2.85 },
        { text: "ٱلْأَفْـِٔدَةِ", from: 2.85, to: 4.88 }
      ],
      8: [
        { text: "إِنَّهَا", from: 0.00, to: 1.45 },
        { text: "عَلَيْهِم", from: 1.45, to: 2.95 },
        { text: "مُّؤْصَدَةٌ", from: 2.95, to: 5.25 }
      ],
      9: [
        { text: "فِى", from: 0.00, to: 0.70 },
        { text: "عَمَدٍ", from: 0.70, to: 1.62 },
        { text: "مُّمَدَّدَةٍۭ", from: 1.62, to: 4.00 }
      ]
    }
  };
  // asr (surah 103)
  GOL.WORD_FOLLOW.basit[103] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [2.0114, 5.7992, 10.7886],
    verses: {
      1: [
        { text: "وَٱلْعَصْرِ", from: 0.00, to: 2.01 }
      ],
      2: [
        { text: "إِنَّ", from: 0.00, to: 0.79 },
        { text: "ٱلْإِنسَـٰنَ", from: 0.79, to: 3.12 },
        { text: "لَفِى", from: 3.12, to: 4.14 },
        { text: "خُسْرٍ", from: 4.14, to: 5.80 }
      ],
      3: [
        { text: "إِلَّا", from: 0.00, to: 0.60 },
        { text: "ٱلَّذِينَ", from: 0.60, to: 1.46 },
        { text: "ءَامَنُوا۟", from: 1.46, to: 2.52 },
        { text: "وَعَمِلُوا۟", from: 2.52, to: 3.57 },
        { text: "ٱلصَّـٰلِحَـٰتِ", from: 3.57, to: 5.09 },
        { text: "وَتَوَاصَوْا۟", from: 5.09, to: 6.44 },
        { text: "بِٱلْحَقِّ", from: 6.44, to: 7.22 },
        { text: "وَتَوَاصَوْا۟", from: 7.22, to: 8.57 },
        { text: "بِٱلصَّبْرِ", from: 8.57, to: 10.79 }
      ]
    }
  };
  // takathur (surah 102)
  GOL.WORD_FOLLOW.basit[102] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [3.3437, 4.0229, 3.8922, 5.2506, 5.3812, 3.9445, 6.9224, 8.2808],
    verses: {
      1: [
        { text: "أَلْهَىٰكُمُ", from: 0.00, to: 1.42 },
        { text: "ٱلتَّكَاثُرُ", from: 1.42, to: 3.34 }
      ],
      2: [
        { text: "حَتَّىٰ", from: 0.00, to: 1.15 },
        { text: "زُرْتُمُ", from: 1.15, to: 1.98 },
        { text: "ٱلْمَقَابِرَ", from: 1.98, to: 4.02 }
      ],
      3: [
        { text: "كَلَّا", from: 0.00, to: 1.03 },
        { text: "سَوْفَ", from: 1.03, to: 1.88 },
        { text: "تَعْلَمُونَ", from: 1.88, to: 3.89 }
      ],
      4: [
        { text: "ثُمَّ", from: 0.00, to: 0.74 },
        { text: "كَلَّا", from: 0.74, to: 1.91 },
        { text: "سَوْفَ", from: 1.91, to: 2.87 },
        { text: "تَعْلَمُونَ", from: 2.87, to: 5.25 }
      ],
      5: [
        { text: "كَلَّا", from: 0.00, to: 0.88 },
        { text: "لَوْ", from: 0.88, to: 1.39 },
        { text: "تَعْلَمُونَ", from: 1.39, to: 2.71 },
        { text: "عِلْمَ", from: 2.71, to: 3.30 },
        { text: "ٱلْيَقِينِ", from: 3.30, to: 5.38 }
      ],
      6: [
        { text: "لَتَرَوُنَّ", from: 0.00, to: 1.71 },
        { text: "ٱلْجَحِيمَ", from: 1.71, to: 3.94 }
      ],
      7: [
        { text: "ثُمَّ", from: 0.00, to: 0.75 },
        { text: "لَتَرَوُنَّهَا", from: 0.75, to: 3.18 },
        { text: "عَيْنَ", from: 3.18, to: 4.15 },
        { text: "ٱلْيَقِينِ", from: 4.15, to: 6.92 }
      ],
      8: [
        { text: "ثُمَّ", from: 0.00, to: 0.80 },
        { text: "لَتُسْـَٔلُنَّ", from: 0.80, to: 2.73 },
        { text: "يَوْمَئِذٍ", from: 2.73, to: 4.61 },
        { text: "عَنِ", from: 4.61, to: 5.18 },
        { text: "ٱلنَّعِيمِ", from: 5.18, to: 8.28 }
      ]
    }
  };
  // qariah (surah 101)
  GOL.WORD_FOLLOW.basit[101] = {
    provenance: "ESTIMATED (mora-weighted, unvalidated) from local basit mp3 durations; refine by ear",
    audioDurations: [2.3771, 2.6645, 5.3551, 6.8441, 6.609, 6.4784, 4.2057, 5.6163, 3.631, 4.6237, 2.7429],
    verses: {
      1: [
        { text: "ٱلْقَارِعَةُ", from: 0.00, to: 2.38 }
      ],
      2: [
        { text: "مَا", from: 0.00, to: 0.60 },
        { text: "ٱلْقَارِعَةُ", from: 0.60, to: 2.66 }
      ],
      3: [
        { text: "وَمَآ", from: 0.00, to: 1.10 },
        { text: "أَدْرَىٰكَ", from: 1.10, to: 2.55 },
        { text: "مَا", from: 2.55, to: 3.10 },
        { text: "ٱلْقَارِعَةُ", from: 3.10, to: 5.36 }
      ],
      4: [
        { text: "يَوْمَ", from: 0.00, to: 0.82 },
        { text: "يَكُونُ", from: 0.82, to: 1.83 },
        { text: "ٱلنَّاسُ", from: 1.83, to: 3.07 },
        { text: "كَٱلْفَرَاشِ", from: 3.07, to: 4.55 },
        { text: "ٱلْمَبْثُوثِ", from: 4.55, to: 6.84 }
      ],
      5: [
        { text: "وَتَكُونُ", from: 0.00, to: 1.37 },
        { text: "ٱلْجِبَالُ", from: 1.37, to: 2.82 },
        { text: "كَٱلْعِهْنِ", from: 2.82, to: 4.14 },
        { text: "ٱلْمَنفُوشِ", from: 4.14, to: 6.61 }
      ],
      6: [
        { text: "فَأَمَّا", from: 0.00, to: 1.55 },
        { text: "مَن", from: 1.55, to: 2.13 },
        { text: "ثَقُلَتْ", from: 2.13, to: 3.28 },
        { text: "مَوَٰزِينُهُۥ", from: 3.28, to: 6.48 }
      ],
      7: [
        { text: "فَهُوَ", from: 0.00, to: 0.72 },
        { text: "فِى", from: 0.72, to: 1.23 },
        { text: "عِيشَةٍ", from: 1.23, to: 2.23 },
        { text: "رَّاضِيَةٍ", from: 2.23, to: 4.21 }
      ],
      8: [
        { text: "وَأَمَّا", from: 0.00, to: 1.47 },
        { text: "مَنْ", from: 1.47, to: 1.96 },
        { text: "خَفَّتْ", from: 1.96, to: 2.89 },
        { text: "مَوَٰزِينُهُۥ", from: 2.89, to: 5.62 }
      ],
      9: [
        { text: "فَأُمُّهُۥ", from: 0.00, to: 1.28 },
        { text: "هَاوِيَةٌ", from: 1.28, to: 3.63 }
      ],
      10: [
        { text: "وَمَآ", from: 0.00, to: 1.16 },
        { text: "أَدْرَىٰكَ", from: 1.16, to: 2.68 },
        { text: "مَا", from: 2.68, to: 3.26 },
        { text: "هِيَهْ", from: 3.26, to: 4.62 }
      ],
      11: [
        { text: "نَارٌ", from: 0.00, to: 0.91 },
        { text: "حَامِيَةٌۢ", from: 0.91, to: 2.74 }
      ]
    }
  };
